    ...
    <main>
      ...
      >
        <div class="text-center">
          <h6 class="text-work mb-3">HOW WE WORK</h6>
          <p>
        ...
        <div class="row align-items-center mb-5">
          ...
          <div class="col-lg-6 text-start">
            ...
            <h2 class="about-us-title">
              Let's talk about your company's problems first
            </h2>
            <p class="mb-5">
              After submitting the quote form, we will review the data, then
              <br />
              we will contact you. You can discuss with our team regarding
              <br />
              your problem and find a solution to that problem.
            </p>
            <p>In this step, you will discuss what application to build.</p>
          </div>
        </div>
      </section>
      ...
      <section class="about-us-section container">
        <div class="row align-items-center flex-row-reverse mb-5">
          ...
          <div class="col-lg-6 text-start">
            ...
            <p class="mb-5">
              When everything is agreed upon, our team will make plans <br />
        ...
        <div class="row align-items-center mb-5">
          ...
          <div class="col-lg-6 text-start">
            ...
            <p class="mb-5">
              ...
              <br />
              you, don't worry. These assets include, design files, source
              <br />
              code, server access, and so on.
            </p>
            <p>In this step, everything is done and the contract ends.</p>
          </div>
        </div>
      </section>
      <!-- End Section About -->
